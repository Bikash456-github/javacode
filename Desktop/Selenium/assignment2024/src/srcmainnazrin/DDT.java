package srcmainnazrin;
	...
	public class DDT 
	{
		...
		public void ddt_login() throws EncryptedDocumentException, IOException
		{
		    ...
		    username = NumberToTextConverter.toText(w1.getSheet("Bikash").getRow(1).getCell(0).getNumericCellValue());
		    password_valid = w1.getSheet("Bikash").getRow(1).getCell(0).getStringCellValue();
		    password_invalid = w1.getSheet("Bikash").getRow(1).getCell(1).getStringCellValue();
		}
